...
namespace CxxTest
{
                                ...
                                void* /* arg */ )
    {
        ...
        switch ( signum )
        {
            ...
            case SIGSEGV:
                msg = "SIGSEGV: segmentation fault "
                    "(null or invalid pointer/array element access?)";
                break;
        ...
        // This check makes sure the Dereferee memory manager doesn't get
        // recreated if a signal gets raised after the manager is destroyed.
        if (Dereferee::manager::existing_instance())
        {
